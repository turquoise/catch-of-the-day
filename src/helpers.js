...
export function getFunName() {
  ...
  const nouns = ['dwarves', 'magicians', 'goats', 'teeth', 'feet', 'dogs', 'leaves', 'mice', 'geese', 'halves', 'knives', 'cats', 'lives', 'elves', 'loaves', 'potatoes', 'tomatoes', 'cacti', 'foci', 'fungi', 'nuclei', 'syllabuses', 'analyses', 'diagnoses', 'oases', 'theses', 'crises', 'phenomena', 'criteria', 'data'];
